-- ------------------------------------------------------------------
-- Source: https://github.com/MIT-LCP/mimic-code/blob/main/mimic-iii/concepts/pivot/pivoted_vital.sql
-- Necessary adjustments: 
-- `physionet-data.mimiciii_clinical.chartevents` to mimiciii.chartevents
-- To create this table under the schema mimiciii with command: \i path_to_file/pivoted_vital.sql
